<?php
/*****************************************************************************
 * ExecEntitiesVisitor.php
 *     Name: Exec Entities Visitor
 *     Date: 2009/01/08
...
require_once 'T_execution.php';

/**
 * ExecEntitiesVisitor: 階層構造をもつ実体をトラバースするクラス
 * @author  makoto.warashina@gmail.com
 * @access  public
 * @package Libs
 */
class ExecEntitiesVisitor
{
     ...
     */
    public function detailView($paramEntity )
    {
        //実体からコレクションを取得
