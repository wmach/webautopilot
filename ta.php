...
class TradeAgent
{
    ...
    {
        $rtnArray = array();
        $rtnArray[CodesConstants::T_POSITION_PID]=1;//ポジションID: PRIMARY KEY
        $rtnArray[CodesConstants::T_POSITION_CODE] = 9448;    //銘柄コード
        $rtnArray[CodesConstants::T_POSITION_LS]=             //売買区分
            CodesConstants::ORD_LS_SHINKI_KAI;
        $rtnArray[CodesConstants::T_POSITION_ENTRY_EXIT]=NULL;//取引区分
        $rtnArray[CodesConstants::T_POSITION_PRICE]=200;      //価格
        $rtnArray[CodesConstants::T_POSITION_QTY]=1;          //数量
